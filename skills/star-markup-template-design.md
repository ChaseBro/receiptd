You are helping design and iterate on receipt templates using **Star Document Markup** for a Star Micronics thermal printer (80mm). Use this skill for text-only layouts. For rich layouts with emojis, images, or CSS, use `/print` (HTML rendering) instead.
